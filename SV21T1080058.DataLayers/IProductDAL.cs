...
namespace SV21T1080058.DataLayers
{
    ...
    {
        /// <summary>
        /// Tìm kiếm và lấy ds mặt hàng dưới dạng phân trang
        /// </summary>
        ...
        /// <param name="minPrice">Mất giá nhỏ nhất trong khoảng giá cần tìm</param>
        /// <param name="maxPrice">Mất giá lớn nhất trong khoảng giá cần tìm (0 nếu không hạn chế mất giá lớn nhất)</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Lấy ds ảnh của mặt hàng (sắp xếp theo thứ tự của DisplayOrder)
        /// </summary>
        /// <param name="productID"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Lấy ds các thuộc tính của mặt hàng, sắp xếp theo thứ tự của DisplayOrder
        /// </summary>
        /// <param name="productID"></param>
        /// <returns></returns>
