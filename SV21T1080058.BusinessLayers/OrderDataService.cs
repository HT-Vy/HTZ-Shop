    ...
    public static class OrderDataService
    {
                    ...
                    IEnumerable<OrderDetail> details)
        {
            ...
            Order data = new Order()
            {
                ...
                Status = 1 //trạng thái khởi tạo đơn hàng
            };
        ...
        /// khi đang ở trạng thái chờ duyệt, bị hủy hoặc từ chối
        /// </summary>
        ...
        {
            Order? data = orderDB.Get(orderID); if (data == null)
                return false;
            if (data.Status == Constants.ORDER_INIT || data.Status == Constants.ORDER_ACCEPTED)
            {
        ...
        /// <summary>
        /// Cập nhật thông tin tỉnh/thành giao hàng và địa chỉ giao hàng của 1 đơn hàng
        /// </summary>
        /// <param name="orderID"></param>
        /// <param name="newDeliveryProvince"></param>
        /// <param name="newDeliveryAddress"></param>
        /// <returns></returns>
        public static bool UpdateOrderDeliveryAddress(int orderID, string deliveryProvince, string deliveryAddress)
        {
            Order? data = orderDB.Get(orderID);
            if (data == null)
                return false;
